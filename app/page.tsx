...
export default function Home() {
  ...
  const { user, loading, error, signInWithGoogle, isAdmin } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-bg-light">
      {/* Global Header - Only show if authenticated */}
      {user && <GlobalHeader />}

      {/* Landing Header - Only show if NOT authenticated */}
      {!user && (
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {loading ? (
                ...
                <BrutalButton onClick={signInWithGoogle} variant="primary" className="gap-2">
      ...
      {error && (
        <div className="max-w-6xl mx-auto px-6 pt-6">
          <div className="p-4 border-4 border-alert-orange bg-alert-orange/10 text-dark">
